...
<div className="flex-1 bg-[#edebe9] rounded-lg border border-[#d2d0ce] shadow-inner overflow-x-auto overflow-y-auto p-6 flex justify-center">
  {isPdf ? (
    ...
    /* Trang giấy A4 tự động ép gọn bảng vào lề */
    <div className="w-[210mm] min-h-[297mm] h-fit bg-white border border-[#c8c6c4] shadow-md p-[12mm] rounded-xs text-[#201f1e] relative mb-10 shrink-0">
      ...
      {/* Vùng soạn thảo Word với cấu hình Table ép vừa khung A4 */}
      <div
        ref={containerRef}
        ...
        className="outline-none w-full text-sm text-[#201f1e] bg-white leading-relaxed font-['Times_New_Roman',Times,serif] 
          ...
          [&_td]:border [&_td]:border-[#323130] [&_td]:p-0.5 [&_td]:text-center [&_td]:align-middle [&_td]:text-[10px] [&_td]:break-all [&_td]:focus:bg-[#eff6fc] [&_td]:focus:outline-2 [&_td]:focus:outline-[#0078d4]
